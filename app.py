...
def get_treatment_plan():
    ...
    user_query = f"Provide a simple step-by-step treatment plan in HINDI for a small-scale mango farmer for {disease_name}. Use easy to understand farmer-friendly language."
